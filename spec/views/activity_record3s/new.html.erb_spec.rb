...
describe "activity_record3s/new" do
  before(:each) do
    assign(:activity_record3, stub_model(ActivityRecord3,
      :user => nil,
      :coach => nil,
      :weekday => nil,
      :start_time => 1,
  ...
  it "renders new activity_record3 form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", activity_record3s_path, "post" do
