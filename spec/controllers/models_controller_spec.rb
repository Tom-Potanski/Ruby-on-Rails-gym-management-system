...
describe ModelsController do
  ...
  let(:valid_attributes) { { "weekday" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved model as @model" do
        ...
        post :create, {:model => { "weekday" => "invalid value" }}, valid_session
        assigns(:model).should be_a_new(Model)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested model" do
        ...
        Model.any_instance.should_receive(:update).with({ "weekday" => "MyString" })
        put :update, {:id => model.to_param, :model => { "weekday" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the model as @model" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Model.any_instance.stub(:save).and_return(false)
        put :update, {:id => model.to_param, :model => { "weekday" => "invalid value" }}, valid_session
        assigns(:model).should eq(model)
      end
